...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      // Maps custom CSS variables (from src/global.css) to Tailwind classes
      colors: {
        ...
        // Include your custom ParkSense colors for completeness
        ...
        // ... you can add the rest of your custom colors here
      },
      borderRadius: {
        lg: "var(--radius)",
  ...
  plugins: [
    // You may need to add a Tailwind plugin here for custom functionality
  ],
}